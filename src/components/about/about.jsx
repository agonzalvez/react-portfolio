...
export default function Intro() {
  ...
  return (
    <div className="about" id="about">
      ...
      <div className="right">
        <h4>Alejandro Gonzálvez is a full-stack developer, photographer, video editor, with a degree in advertising from Florida International University, and a Web Developer Certificate from UCLA. 
